...
- **auth-service** — логин и проверка JWT (порт 8081, PostgreSQL, RS256)
...
- **Чистые бизнес‑сервисы**. `auth-service` отвечает за логин/refresh, а бизнес‑логика — отдельно.
